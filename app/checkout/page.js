...
export default function CheckoutPage() {
    ...
    useEffect(() => {
        const savedDetails = localStorage.getItem("cellfixCheckoutDetails");
        if (savedDetails) {
            try {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            localStorage.setItem("cellfixCheckoutDetails", JSON.stringify(detailsToSave));
        } catch (error) {
            ...
            <div className="flex min-h-[70vh] flex-col items-center justify-center bg-gray-50">
                <div className="text-center px-4">
                    <div className="w-24 h-24 bg-orange-50 rounded-full flex items-center justify-center mx-auto mb-6">
                        <ShoppingBag className="h-12 w-12 text-brand-orange/40" />
                    </div>
                    ...
                    <Link
                        href="/"
                        className="mt-6 inline-block rounded-xl bg-brand-orange px-8 py-3.5 text-white font-bold hover:bg-[#ff1a2b] transition-colors shadow-lg shadow-brand-orange/20"
                    >
                        Continue Shopping
                    </Link>
                </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <section className="rounded-2xl border border-gray-100 bg-white p-5 md:p-6 shadow-sm">
                                <div className="mb-5 flex items-center gap-3 border-b border-gray-100 pb-4">
                                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-orange-50 text-brand-orange">
                                ...
                                >
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="block w-full rounded-xl border border-gray-200 bg-gray-50 py-3 pl-10 pr-3 text-sm text-gray-900 placeholder:text-gray-400 focus:border-brand-orange focus:bg-white focus:outline-none focus:ring-1 focus:ring-brand-orange"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            onChange={handleChange}
                                            className="block w-full rounded-xl border border-gray-200 bg-gray-50 py-3 px-4 text-sm text-gray-900 placeholder:text-gray-400 focus:border-brand-orange focus:bg-white focus:outline-none focus:ring-1 focus:ring-brand-orange resize-none"
                            ...
                            <section className="rounded-2xl border border-gray-100 bg-white p-5 md:p-6 shadow-sm">
                                ...
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    {/* Cash on Delivery */}
                                    <label
                                        className={`relative flex cursor-pointer rounded-xl border-2 p-4 transition-all hover:border-brand-orange ${paymentMethod === "Cash"
                        ...
                        <div className="h-fit space-y-6 lg:sticky lg:top-24">
                            <section className="rounded-2xl border border-gray-100 bg-white p-5 md:p-6 shadow-sm">
                                        ...
                                        <div key={`${item.id}-${item.variantKey}-${index}`} className="flex gap-3">
                                            ...
                                            <div className="flex flex-1 flex-col justify-between">
                                                <div className="flex justify-between">
                                                    ...
                                                    <p className="text-sm font-extrabold text-brand-orange whitespace-nowrap">
                                            ...
                                            <div className="flex gap-2">
                                                <input
                                                    ...
                                                    className={`flex-1 rounded-xl border px-4 py-2.5 text-sm focus:outline-none ${couponError
                                                        ...
                                                        : "border-gray-200 bg-gray-50 focus:border-brand-orange"
                                                        }`}
                                                    style={{ fontSize: '16px' }}
                                                />
                                                <button
                                                    ...
                                                    className="rounded-xl bg-brand-orange px-5 py-2.5 text-xs font-bold text-white transition hover:bg-[#ff1a2b] disabled:opacity-50"
                                                >
                                                    {couponLoading ? "..." : "Apply"}
                                                </button>
                                            </div>
                                ...
                                <button
                                    ...
                                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-brand-orange px-6 py-4 text-sm font-extrabold text-white shadow-lg shadow-brand-orange/20 transition-all hover:bg-[#ff1a2b] hover:translate-y-[-1px] hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-70"
                                >
                                    {isSubmitting ? (
                                        <>
