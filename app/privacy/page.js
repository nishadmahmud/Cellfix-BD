...
export const metadata = {
    title: "Privacy Policy | CellfixBD",
    description: "CellfixBD privacy policy — how we collect, use, and protect your personal information.",
};
...
const sections = [
    {
        ...
        content: [
            ...
            "**Order Information:** Details of products you purchase, repair services you request, order history, and delivery preferences.",
    ...
    },
    {
        ...
        content: [
            "To process and fulfill your orders and repair service requests.",
    ...
    },
    {
        ...
        content: [
            ...
            "You may request a copy of the data we hold about you by contacting us at support@cellfixbd.com.",
        ],
    },
    {
            ...
            <div className="max-w-4xl mx-auto px-4 md:px-8 -mt-6">
                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10">
                    <p className="text-sm text-gray-600 leading-relaxed mb-8">
                        At CellfixBD, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or make a purchase.
                    </p>
                                ...
                                <ul className="space-y-2">
                                    {section.content.map((item, j) => (
                                        <li key={j} className="text-sm text-gray-600 leading-relaxed flex items-start gap-2">
                                            <span className="text-brand-orange mt-1.5 flex-shrink-0">•</span>
                    ...
                    <div className="mt-10 p-5 bg-gray-50 rounded-xl border border-gray-100">
                        <p className="text-sm text-gray-600">
                            ...
                            <a href="mailto:support@cellfixbd.com" className="text-brand-orange font-semibold hover:underline">support@cellfixbd.com</a> or call{" "}
                            <a href="tel:+8801714404100" className="text-brand-orange font-semibold hover:underline">+880 1714-404100</a>.
                        </p>
                    </div>
                </div>
            </div>
