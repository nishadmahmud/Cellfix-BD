...
export default function ProductDetailsPage() {
    ...
    return (
        <div className="bg-white min-h-screen pb-12">
            <div className="border-b border-brand-orange/10 bg-gradient-to-r from-brand-orange/5 to-transparent py-4 md:py-6 mb-6 md:mb-10">
                <div className="max-w-7xl mx-auto px-4 md:px-6">
                    <div className="text-[11px] md:text-sm text-gray-500 flex items-center gap-2 font-medium">
                        <Link href="/" className="hover:text-brand-orange cursor-pointer transition-colors">Home</Link>
                        <span>/</span>
                        {fromCategory && productData?.category?.name && (
                            <>
                                <Link
                                    href={`/category/${productData.category.slug}`}
                                    className="hover:text-brand-orange cursor-pointer transition-colors capitalize"
                                >
                        ...
                        <span className="text-brand-orange font-bold capitalize truncate">{productName}</span>
                    </div>
                </div>
            </div>
