...
export const metadata = {
    title: "Refund Policy | CellfixBD",
    description: "CellfixBD refund and return policy — learn about our return process, eligibility, and refund timelines.",
};
...
const faqs = [
    ...
    { q: "Are repair services refundable?", a: "Repair service fees are non-refundable once the repair is completed. If you are unsatisfied with a repair, please contact us within 7 days and we will re-inspect the device at no additional cost." },
];
        ...
        <div className="min-h-screen bg-gray-50 pb-20 md:pb-10">
            <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
                <div className="max-w-4xl mx-auto px-4 md:px-8 py-12 md:py-20 text-center">
                    <span className="inline-block px-4 py-1.5 bg-brand-orange/20 text-brand-orange text-xs font-bold rounded-full mb-4 border border-brand-orange/20">POLICY</span>
            ...
            <div className="max-w-4xl mx-auto px-4 md:px-8 -mt-6 space-y-6">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10">
                    <p className="text-sm text-gray-600 leading-relaxed mb-6">
                        At CellfixBD, we want you to be completely happy with your purchase. If you&apos;re not satisfied, we offer a hassle-free return and refund process. Please read the details below carefully.
                    </p>
                    ...
                    <div className="space-y-4 mb-8">
                        {[
                            { step: 1, title: "Contact Us", desc: "Call us at +880 1714-404100 or email support@cellfixbd.com with your order details and reason for return.", color: "from-blue-500 to-blue-600" },
                            ...
                            { step: 3, title: "Ship the Product", desc: "Pack the item securely in its original packaging and ship it to our store address. Include the RA number with your return.", color: "from-brand-orange to-orange-500" },
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-8">
                        {[
                            { method: "bKash / Nagad", time: "1-3 business days", icon: <Smartphone className="w-6 h-6 text-brand-orange" /> },
                            { method: "Bank Transfer", time: "5-7 business days", icon: <Landmark className="w-6 h-6 text-brand-orange" /> },
                            { method: "Store Credit", time: "Instant", icon: <Tag className="w-6 h-6 text-brand-orange" /> },
                        ].map((item, i) => (
                    ...
                    <div className="p-5 bg-amber-50 rounded-xl border border-amber-200 mb-8">
                        <h3 className="font-bold text-amber-900 mb-2 flex items-center gap-2"><AlertTriangle className="w-5 h-5" /> Repair Services</h3>
                        <p className="text-sm text-amber-800">
                            Repair service fees are non-refundable once work has been completed. If you experience issues after a repair, please contact us within 90 days (warranty period) and we will re-inspect and fix the device at no additional cost. Warranty does not cover physical damage, water damage, or unauthorized modifications.
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10">
                    ...
                    <div className="mt-8 p-5 bg-gray-50 rounded-xl border border-gray-100 text-center">
                        ...
                        <Link href="/contact" className="inline-block px-6 py-2.5 bg-brand-orange text-white font-bold text-sm rounded-xl shadow-lg shadow-brand-orange/30 hover:bg-[#ff1a2b] transition-all">
                            Contact Support
                        </Link>
                    </div>
                </div>
