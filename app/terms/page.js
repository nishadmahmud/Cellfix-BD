...
export const metadata = {
    title: "Terms & Conditions | CellfixBD",
    description: "CellfixBD terms and conditions — rules and regulations for using our website and services.",
};

const sections = [
    {
        title: "1. Acceptance of Terms",
        content: "By accessing and using the CellfixBD website (cellfixbd.com), you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, please do not use our website or services.",
    },
    {
    ...
    {
        title: "5. Repair Services",
        content: "All repairs are performed by certified technicians using quality parts. Repair estimates are provided before work begins. We offer a 90-day warranty on repair labor and parts (unless otherwise specified). The warranty does not cover physical damage, water damage, or unauthorized modifications after the repair. Devices left uncollected for more than 30 days may be subject to storage fees.",
    },
    {
    ...
    },
    {
        ...
        content: "All content on this website — including logos, images, text, graphics, and software — is the property of CellfixBD and is protected by intellectual property laws. You may not reproduce, distribute, or create derivative works from our content without explicit written permission.",
    },
    {
        title: "9. Limitation of Liability",
        content: "CellfixBD shall not be liable for any indirect, incidental, special, or consequential damages arising from the use of our website or services. Our total liability shall not exceed the amount paid by you for the specific product or service in question.",
    },
    {
        ...
        <div className="min-h-screen bg-gray-50 pb-20 md:pb-10">
            <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
                <div className="max-w-4xl mx-auto px-4 md:px-8 py-12 md:py-20 text-center">
                    <span className="inline-block px-4 py-1.5 bg-brand-orange/20 text-brand-orange text-xs font-bold rounded-full mb-4 border border-brand-orange/20">LEGAL</span>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10">
                    ...
                    <div className="mt-10 p-5 bg-gray-50 rounded-xl border border-gray-100">
                        <p className="text-sm text-gray-600">
                            ...
                            <a href="mailto:support@cellfixbd.com" className="text-brand-orange font-semibold hover:underline">support@cellfixbd.com</a>.
                        </p>
                    </div>
                </div>
            </div>
