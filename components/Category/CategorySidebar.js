    ...
    return (
      ...
      `}>
                ...
                <div className="p-5 lg:p-0 space-y-6 overflow-y-auto h-full lg:h-auto pb-20 lg:pb-0 flex-grow">
                    ...
                    <div className="border-b border-gray-100 pb-6">
                        <button
                            ...
                            className="flex items-center justify-between w-full text-left font-bold text-brand-orange mb-4 uppercase text-sm tracking-wider"
                        >
                                ...
                                <div className="space-y-4 pt-2">
                                    <div className="flex items-center gap-3">
                                        <div className="relative w-full">
                                            <input
                                                ...
                                                className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:border-brand-orange"
                                            />
                                        </div>
                                    ...
                                    <div className="relative h-2 bg-gray-200 rounded-full mt-6 mx-2">
                                        ...
                                        <input
                                            ...
                                            className="absolute w-full -top-1.5 appearance-none bg-transparent pointer-events-none [&::-webkit-slider-thumb]:pointer-events-auto [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-brand-orange [&::-webkit-slider-thumb]:cursor-pointer [&::-moz-range-thumb]:pointer-events-auto [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:w-5 [&::-moz-range-thumb]:h-5 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-brand-orange [&::-moz-range-thumb]:cursor-pointer [&::-moz-range-thumb]:border-0 z-10"
                                        />
                                        ...
                                        <input
                                            ...
                                            className="absolute w-full -top-1.5 appearance-none bg-transparent pointer-events-none [&::-webkit-slider-thumb]:pointer-events-auto [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-brand-orange [&::-webkit-slider-thumb]:cursor-pointer [&::-moz-range-thumb]:pointer-events-auto [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:w-5 [&::-moz-range-thumb]:h-5 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-brand-orange [&::-moz-range-thumb]:cursor-pointer [&::-moz-range-thumb]:border-0 z-20"
                                        />
                                    </div>
                                    ...
                                    {storageList.map(storage => (
                                        <label key={storage} className="flex items-center gap-3 cursor-pointer group">
                                            <div className="relative flex items-center">
                                                <input
                                                    type="checkbox"
                                                    checked={selectedStorage?.includes(storage) || false}
                                                    onChange={() => handleCheckboxChange(storage, selectedStorage, setSelectedStorage)}
                                                    className="peer h-4 w-4 border border-gray-300 rounded text-brand-orange focus:ring-brand-orange"
                                                />
                                            </div>
                                            <span className="text-sm font-medium text-gray-600 group-hover:text-brand-orange transition-colors">{storage}</span>
                                        </label>
                                    ))}
                                </div>
                            )}
                                    ...
                                    {regionList.map(region => (
                                        <label key={region} className="flex items-center gap-3 cursor-pointer group">
                                            <div className="relative flex items-center">
                                                <input
                                                    type="checkbox"
                                                    checked={selectedRegion?.includes(region) || false}
                                                    onChange={() => handleCheckboxChange(region, selectedRegion, setSelectedRegion)}
                                                    className="peer h-4 w-4 border border-gray-300 rounded text-brand-orange focus:ring-brand-orange"
                                                />
                                            </div>
                                            <span className="text-sm font-medium text-gray-600 group-hover:text-brand-orange transition-colors">{region}</span>
                                        </label>
                                    ))}
                                </div>
                            )}
                                    ...
                                    {colorList.map(color => (
                                        <button
                                            ...
                                            className={`w-8 h-8 rounded-full border shadow-sm transition-transform hover:scale-110 relative ${selectedColor?.includes(color.name)
                                                ? 'ring-2 ring-brand-orange ring-offset-2 border-brand-orange'
                                                : 'border-gray-200'
                                                }`}
                            ...
                            <div className="space-y-3">
                                <label className="flex items-center gap-3 cursor-pointer group">
                                    <input
                                        ...
                                        className="h-4 w-4 border border-gray-300 rounded-full text-brand-orange focus:ring-brand-orange"
                                    />
                                    <span className="text-sm font-medium text-gray-600 group-hover:text-brand-orange">All</span>
                                </label>
                                <label className="flex items-center gap-3 cursor-pointer group">
                                    <input
                                        type="radio"
                                        ...
                                        className="h-4 w-4 border border-gray-300 rounded-full text-brand-orange focus:ring-brand-orange"
                                    />
                                    <span className="text-sm font-medium text-gray-600 group-hover:text-brand-orange">In Stock</span>
                                </label>
                            </div>
                        )}
                    </div>
                ...
                <div className="lg:hidden p-4 border-t border-gray-100 bg-white flex gap-3 mt-auto">
                    <button onClick={handleReset} className="flex-1 py-3 border border-gray-200 rounded-xl text-brand-orange font-bold text-sm">
                        Reset
                    </button>
                    <button onClick={onClose} className="flex-1 py-3 bg-brand-orange text-white rounded-xl font-bold text-sm shadow-lg shadow-brand-orange/20">
                        Apply Filters
                    </button>
                </div>
            </aside>
