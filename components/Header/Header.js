...
export default function Header() {
  return (
    <header className="w-full shadow-sm sticky top-0 z-50 bg-white">
      ...
      {/* Main Navigation */}
      <div className="bg-brand-orange py-2.5 md:py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-3 md:px-6 gap-3 md:gap-4">
          ...
          <div className="flex-grow max-w-lg flex items-center bg-white rounded-lg px-3 md:px-4 py-1.5 md:py-2 shadow-sm focus-within:ring-2 focus-within:ring-white/50 transition-all">
            <input
              type="text"
              placeholder="Search..."
          ...
          <div className="flex gap-2 md:gap-4 items-center">
            ...
            <button className="text-white hover:text-white/80 transition-colors relative p-1" aria-label="Cart">
              ...
              <span className="absolute -top-1 -right-1 bg-white text-brand-orange text-[8px] md:text-[10px] font-bold h-3.5 w-3.5 md:h-4 md:w-4 rounded-full flex items-center justify-center shadow-sm">
                0
              </span>
            </button>
          </div>
