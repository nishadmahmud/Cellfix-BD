        ...
        <div className="flex flex-col">
            ...
            <div className="flex justify-between items-start mb-2">
                <div>
                    ...
                    <div className="flex items-center gap-2 mb-6 cursor-pointer group">
                        ...
                        <span className="text-gray-500 text-sm group-hover:text-brand-orange transition-colors">
                            (12 Reviews)
                        </span>
                    </div>
                </div>
            ...
            <div className="space-y-6 mb-8">
                ...
                {product.variants?.storage && (
                    <div>
                        <h3 className="text-sm font-bold text-gray-900 mb-3">Storage:</h3>
                ...
                {product.variants?.regions && (
                    <div>
                        <h3 className="text-sm font-bold text-gray-900 mb-3">Region:</h3>
                        <div className="flex flex-wrap gap-2">
