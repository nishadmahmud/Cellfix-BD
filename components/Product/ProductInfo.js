    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex justify-between items-start mb-2">
                <div>
                    <div className="bg-orange-50 text-brand-orange text-xs font-bold px-2.5 py-1 rounded-md inline-block mb-3">
                        In Stock
                    </div>
                ...
                <button className="p-2 text-gray-400 hover:text-brand-orange hover:bg-orange-50 rounded-full transition-colors">
                    <FiShare2 size={20} />
                </button>
            </div>
            ...
            {hasVariants && (
                <div className="space-y-6 mb-8">
                    ...
                    {allColors.length > 0 && (
                        <div>
                            <h3 className="text-sm font-bold text-gray-900 mb-3">
                                Color: <span className="font-medium text-brand-orange">{selectedColor || ''}</span>
                            </h3>
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`cursor-pointer flex items-center gap-2.5 px-3.5 py-2.5 rounded-xl border-2 transition-all duration-200 ${isSelected
                                                ? 'border-brand-orange bg-orange-50 shadow-md shadow-brand-orange/10'
                                        ...
                                        >
                                            ...
                                            />
                                            <span className={`text-sm font-medium ${isSelected ? 'text-brand-orange' : 'text-gray-600'}`}>
                                                {color.name}
                                            </span>
                                        </button>
                                    );
                    ...
                    {allStorages.length > 0 && (
                        <div>
                            <h3 className="text-sm font-bold text-gray-900 mb-3">
                                Storage: <span className="font-medium text-brand-orange">{selectedStorage || ''}</span>
                            </h3>
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`cursor-pointer px-4 py-2.5 rounded-xl text-sm font-semibold border-2 transition-all duration-200 ${isSelected
                                                ...
                                                : isAvailable
                                                    ? 'border-gray-200 text-gray-600 hover:border-brand-orange/50 hover:shadow-sm'
                    ...
                    {allRegions.length > 0 && (
                        <div>
                            <h3 className="text-sm font-bold text-gray-900 mb-3">
                                Region: <span className="font-medium text-brand-orange">{selectedRegion || ''}</span>
                            </h3>
                            <div className="flex flex-wrap gap-2">
                                {allRegions.map(region => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            disabled={!isAvailable}
                                            className={`cursor-pointer px-4 py-2.5 rounded-xl text-sm font-semibold border-2 transition-all duration-200 ${isSelected
                                                ? 'border-brand-orange text-brand-orange bg-brand-orange/5 shadow-md shadow-brand-orange/10'
                                                : isAvailable
                                                    ? 'border-gray-200 text-gray-600 hover:border-brand-orange/50 hover:shadow-sm'
                                                    : 'border-gray-100 text-gray-300 cursor-not-allowed bg-gray-50 line-through'
                                                }`}
            ...
            <div className="flex flex-row items-stretch gap-2 mt-4">
                ...
                <div className="flex items-center justify-between border-2 border-gray-200 rounded-lg py-1 px-1 w-[100px] shrink-0 bg-white">
                    <button
                        ...
                        className="cursor-pointer w-8 h-8 flex items-center justify-center text-gray-500 hover:text-brand-orange hover:bg-gray-100 rounded-md transition-colors"
                    >
                        <FiMinus size={14} />
                    </button>
                ...
                <button
                    ...
                    className="cursor-pointer flex-1 bg-white border-2 border-brand-orange text-brand-orange font-bold py-3 px-2 rounded-lg hover:bg-brand-orange hover:text-white transition-colors text-sm whitespace-nowrap"
                >
                    Add to Cart
                </button>
