...
export default function ProductTabs({ description, specifications }) {
    ...
    return (
        <div className="mt-12 md:mt-24 w-full">
            ...
            <div className="flex items-center gap-6 md:gap-10 border-b border-gray-200 mb-8">
                ...
                >
                    ...
                    {activeTab === 'description' && (
                        <span className="absolute bottom-[-1px] left-0 w-full h-[3px] bg-brand-orange rounded-t-lg"></span>
                    )}
                </button>
                <button
            ...
            {/* Content Area */}
            <div className="prose prose-sm md:prose-base max-w-none text-gray-600 leading-relaxed md:leading-loose overflow-hidden break-words">
                {activeTab === 'description' ? (
