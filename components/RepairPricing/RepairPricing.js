...
export default function RepairPricing() {
    ...
    const pricingData = {
        ...
        'Samsung': [
            ...
            { model: "Galaxy Note 20 Ultra", screen: "14,000", battery: "3,000", backGlass: "4,000" },
            { model: "Galaxy A54", screen: "5,000", battery: "2,000", backGlass: "2,000" },
        ],
        'iPad': [
            { model: "iPad Pro 12.9\" (M2)", screen: "25,000", battery: "5,000", backGlass: "—" },
            { model: "iPad Pro 11\" (M2)", screen: "20,000", battery: "4,500", backGlass: "—" },
            { model: "iPad Air (5th Gen)", screen: "15,000", battery: "4,000", backGlass: "—" },
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-gray-500 max-w-2xl mx-auto">
                        Transparent pricing. No hidden fees. All repairs come with a warranty.
                    </p>
                </div>
                    ...
                    <div className="inline-flex bg-white rounded-xl p-1.5 shadow-sm border border-gray-100">
                        {devices.map((device) => (
                            <button
                                ...
                                className={`px-6 py-2.5 text-sm font-bold rounded-lg transition-all duration-200 ${activeDevice === device
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    {/* Table Header */}
                    <div className="grid grid-cols-4 bg-gray-900 text-white text-xs md:text-sm font-bold uppercase tracking-wider">
                        <div className="px-4 md:px-6 py-4">Device Model</div>
                        <div className="px-4 md:px-6 py-4 text-center">Screen</div>
                        <div className="px-4 md:px-6 py-4 text-center">Battery</div>
                        <div className="px-4 md:px-6 py-4 text-center">Back Glass</div>
                    </div>
                    ...
                    {activePricing.map((item, idx) => (
                        <div
                            key={idx}
                            className={`grid grid-cols-4 text-sm md:text-base border-b border-gray-50 hover:bg-orange-50/50 transition-colors ${idx % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'
                                }`}
                        >
                            <div className="px-4 md:px-6 py-4 font-semibold text-gray-900">
                                {item.model}
                            </div>
                            <div className="px-4 md:px-6 py-4 text-center font-bold text-brand-orange">
                                ৳{item.screen}
                            </div>
                            <div className="px-4 md:px-6 py-4 text-center font-bold text-gray-700">
                                ৳{item.battery}
                            </div>
                            <div className="px-4 md:px-6 py-4 text-center font-bold text-gray-700">
                ...
                <div className="mt-8 text-center">
                    <p className="text-sm text-gray-400">
                        * Prices are approximate and may vary based on availability. Contact us for an exact quote.
                    </p>
                </div>
            </div>
        </section>
