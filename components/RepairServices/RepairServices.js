            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-8 md:mb-16 max-w-2xl mx-auto">
                    ...
                    <p className="text-sm md:text-lg text-gray-500">
                        From simple screen swaps to complex motherboard repair, no one beats our success rate.
                    </p>
                </div>

                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8">
                    {services.map((service, idx) => (
                        <div key={idx} className="group bg-white rounded-xl md:rounded-2xl p-4 md:p-8 text-center border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 md:hover:-translate-y-2 hover:border-brand-orange/50 transition-all duration-300 cursor-pointer">
                            <div className="w-10 h-10 md:w-16 md:h-16 mx-auto mb-3 md:mb-6 bg-orange-50 rounded-full flex items-center justify-center text-xl md:text-3xl text-brand-orange group-hover:scale-110 transition-transform duration-300">
                                {service.icon}
                            </div>
                ...
                <div className="mt-8 md:mt-16 text-center">
                    <Link href="/services" className="inline-flex items-center justify-center font-bold text-sm md:text-base text-brand-orange hover:text-orange-700 underline underline-offset-4 decoration-2 decoration-brand-orange/30 hover:decoration-brand-orange transition-all">
