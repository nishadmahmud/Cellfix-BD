                ...
                <div className="flex items-center justify-between p-5 border-b border-gray-100 bg-white z-10">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-brand-orange font-bold uppercase tracking-wider">{cartItems.length} {cartItems.length === 1 ? 'Item' : 'Items'}</p>
                        </div>
                    </div>
                    <button
                        onClick={closeCart}
                ...
                <div className="flex-1 overflow-y-auto p-5 bg-gray-50/50">
                    {cartItems.length === 0 ? (
                        <div className="h-full flex flex-col items-center justify-center text-center space-y-4">
                            <div className="w-24 h-24 bg-orange-50 rounded-full flex items-center justify-center text-brand-orange/30 mb-2">
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <div className="flex-1 flex flex-col justify-between">
                                            ...
                                            <div className="flex items-end justify-between mt-3">
                                                <div className="font-extrabold text-brand-orange text-sm relative top-1">
                    ...
                    <div className="p-5 bg-white border-t border-gray-100 shadow-[0_-10px_30px_rgba(0,0,0,0.03)] z-10">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <Link href="/checkout" onClick={closeCart} className="w-full">
                                <button className="w-full py-3.5 px-4 bg-brand-orange hover:bg-[#ff1a2b] text-white font-bold rounded-xl shadow-lg shadow-brand-orange/20 transition-all flex items-center justify-center gap-2">
                                    Checkout Now
                                </button>
                            </Link>
                        </div>
