...
// Helper to safely get environment variables, preventing Vercel build crashes
const getApiBaseUrl = () => {
    // In Vercel build phase, env vars might be undefined if not explicitly passed to the build command.
    // Rather than crashing with "Invalid URL", return a dummy URL or the env var.
    return process.env.NEXT_PUBLIC_API || 'https://api.cellfixbd.com';
};

const getUserId = () => {
    return process.env.NEXT_PUBLIC_USER_ID || '1';
};
 ...
 * Set noStore=true for pages that must always be fresh (e.g. home sections).
 * @returns {Promise<Object>} Categories data
 */
export async function getCategoriesFromServer(options = {}) {
    const { noStore = false } = options;

    if (noStore) {
        const res = await fetch(
            `${getApiBaseUrl()}/public/categories/${getUserId()}`,
            { cache: "no-store" }
        );
...
/**
 * Fetch new arrivals from server without caching.
 * @returns {Promise<Object>} New arrivals data
 */
export async function getNewArrivalsFromServer() {
    const res = await fetch(
        `${getApiBaseUrl()}/public/new-arrivals/${getUserId()}`,
        { cache: "no-store" }
    );
...
/**
 * Fetch best deals from server without caching.
 * @returns {Promise<Object>} Best deals data
 */
export async function getBestDealsFromServer() {
    const res = await fetch(
        `${getApiBaseUrl()}/public/best-deals/${getUserId()}`,
        { cache: "no-store" }
    );
...
/**
 * Fetch best selling products without caching.
 * @returns {Promise<Object>} Best sellers data
 */
export async function getBestSellersFromServer() {
    const res = await fetch(
        `${getApiBaseUrl()}/public/best-sellers/${getUserId()}`,
        { cache: "no-store" }
    );
...
export async function getNewUserProductFromServer() {
    const res = await fetch(
        `${getApiBaseUrl()}/public/new-customer-discount/${getUserId()}`,
        {
            cache: "no-cache",
        }
    );
...
/**
 * Fetch sliders from server without caching.
 * @returns {Promise<Object>} Sliders data
 */
export async function getSlidersFromServer() {
    const res = await fetch(
        `${getApiBaseUrl()}/public/sliders/${getUserId()}`,
        { cache: "no-store" }
    );
...
/**
 * Fetch banners from server without caching.
 * @returns {Promise<Object>} Banners data
 */
export async function getBannerFromServer() {
    const res = await fetch(
        `${getApiBaseUrl()}/public/banners/${getUserId()}`,
        { cache: "no-store" }
    );
...
export async function getProductById(product_id) {
    ...
    return getCachedOrFetch(cacheKey, async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/products-detail/${product_id}`,
            { next: { revalidate: 60 } }
        );
...
export async function getRelatedProduct(product_id) {
    ...
    return getCachedOrFetch(cacheKey, async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/get-related-products`,
            {
                method: "POST",
                body: JSON.stringify({
                    product_id,
...
export async function getTopbarData() {
    return getCachedOrFetch('topbar', async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/topbars/${getUserId()}`,
            { next: { revalidate: 300 } }
        );
        return await res.json();
    });
...
export async function getMenuData() {
    return getCachedOrFetch('menu', async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/headers/${getUserId()}`,
            { next: { revalidate: 300 } }
        );
        return await res.json();
    });
...
export async function getFooterData() {
    return getCachedOrFetch('footer', async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/footers/${getUserId()}`,
            { next: { revalidate: 300 } }
        );
...
export async function getProducts(page = 1, category_id = 0, subcategory_id = 0) {
    ...
    return getCachedOrFetch(cacheKey, async () => {
        let url = `${getApiBaseUrl()}/public/products/userwise?user_id=${getUserId()}&page=${page}&per_page=20&category_id=${category_id}`;
...
export async function getProductsBySubcategory(subcategory_id, page = 1) {
    ...
    return getCachedOrFetch(cacheKey, async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/subcategorywise-products/${subcategory_id}?page=${page}`
        );
        return await res.json();
    });
}
...
export async function getProductsByChildCategory(child_id, page = 1) {
    ...
    return getCachedOrFetch(cacheKey, async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/childcategorywise-products/${child_id}?page=${page}`
        );
        return await res.json();
    });
}
...
export async function getBrandwiseProducts(brand_id, page = 1, limit = 20) {
    ...
    return getCachedOrFetch(cacheKey, async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/brandwise-products/${brand_id}/${getUserId()}?page=${page}&limit=${limit}`
        );
        return await res.json();
    });
}
...
export async function getCategoryWiseProducts(category_id, page = 1) {
    ...
    return getCachedOrFetch(cacheKey, async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/categorywise-products/${category_id}?page=${page}`
        );
        return await res.json();
    });
}
...
export async function getFeaturedCategories() {
    return getCachedOrFetch('featured_categories', async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/featured-categories/${getUserId()}`
        );
        return await res.json();
    });
}
...
export async function getTopBrands() {
    return getCachedOrFetch('top_brands', async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/brands/${getUserId()}`,
            { next: { revalidate: 300 } }
        );
        return await res.json();
    });
...
export async function getCampaigns() {
    return getCachedOrFetch('campaigns', async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/campaigns/${getUserId()}`
        );
        return await res.json();
    });
}
...
export async function getCouponList() {
    return getCachedOrFetch('coupons', async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/coupon-list/${getUserId()}`
        );
        return await res.json();
    });
}
...
export async function collectCoupon(couponCode, customerId) {
    const res = await fetch(`${getApiBaseUrl()}/public/collect-coupon`, {
        method: "POST",
        headers: {
...
/**
 * Fetch latest blog posts without caching.
 * @returns {Promise<Object>} Blog posts data
 */
export async function getBlogs() {
    const res = await fetch(
        `${getApiBaseUrl()}/latest-ecommerce-blog-list/${getUserId()}`,
        { cache: "no-store" }
    );
    return await res.json();
}
...
export async function getPopupBanners() {
    return getCachedOrFetch('popup_banners', async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/popups/${getUserId()}`,
            { next: { revalidate: 300 } }
        );
...
export async function customerLogin(email, password) {
    const res = await fetch(`${getApiBaseUrl()}/customer-login`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export async function customerRegister(userData) {
    const res = await fetch(`${getApiBaseUrl()}/customer-registration`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export async function updateCustomerProfile(token, profileData) {
    const res = await fetch(`${getApiBaseUrl()}/customer/update-profile`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
...
export async function getCustomerOrders(token, customerId, type = "1") {
    const res = await fetch(`${getApiBaseUrl()}/customer-order-list`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${token}`
...
export async function updateCustomerPassword(token, passwordData) {
    const res = await fetch(`${getApiBaseUrl()}/customer/update-password`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${token}`
...
/**
 * Search for products without caching so results stay fresh.
 * @param {string} keyword - Search keyword
 * @returns {Promise<Object>} Search results
 */
export async function searchProducts(keyword) {
    const res = await fetch(`${getApiBaseUrl()}/public/search-product`, {
        method: "POST",
        cache: "no-store",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
...
export async function saveSalesOrder(orderData) {
    const res = await fetch(`${getApiBaseUrl()}/public/ecommerce-save-sales`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export async function trackOrder(trackData) {
    ...
    const res = await fetch(`${getApiBaseUrl()}/search-web-invoice`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export async function getCustomerCoupons(customerId) {
    const res = await fetch(`${getApiBaseUrl()}/public/get-customer-coupon/${customerId}`, {
        method: "GET",
    });
...
export async function getStudioList() {
    const res = await fetch(`${getApiBaseUrl()}/public/studio-list/${getUserId()}`, {
        cache: "no-cache",
    });
...
export async function saveProductReview(reviewData, token) {
    const res = await fetch(`${getApiBaseUrl()}/customer/save-customer-review`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${token}`
...
export async function uploadReviewMedia(formData, token) {
    const res = await fetch(`${getApiBaseUrl()}/customer/multiple-file-upload`, {
        method: "POST",
        headers: {
            "Authorization": `Bearer ${token}`
...
export async function uploadSingleFile(formData, token) {
    const res = await fetch(`${getApiBaseUrl()}/customer/file-upload`, {
        method: "POST",
        headers: {
            "Authorization": `Bearer ${token}`
            // Content-Type is inferred from FormData
...
export async function getProductReviews(product_id, page = 1) {
    const res = await fetch(`${getApiBaseUrl()}/public/get-product-reviews/${product_id}?page=${page}`, {
        method: "GET",
    });
...
export async function getAttributes() {
    return getCachedOrFetch('attributes', async () => {
        const res = await fetch(
            `${getApiBaseUrl()}/public/get-attribute-with-values/${getUserId()}`
        );
        return await res.json();
    });
}
...
export async function filterProductsByAttributes(attributeValueIds = [], page = 1, options = {}) {
    ...
    return getCachedOrFetch(cacheKey, async () => {
        ...
        const res = await fetch(
            `${getApiBaseUrl()}/public/filter-products?${params.toString()}`
        );
        return await res.json();
    });
}
...
export async function getPublicStudioList(userId) {
    const res = await fetch(
        `${getApiBaseUrl()}/public/studio-list/${userId}`
    );
    return await res.json();
}
...
export async function getStudioDetails(studioId) {
    const res = await fetch(
        `${getApiBaseUrl()}/studio-details/${studioId}`
    );
    return await res.json();
}
...
export async function saveStudio(studioData) {
    const res = await fetch(`${getApiBaseUrl()}/save-studio`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export async function updateStudio(studioId, studioData) {
    const res = await fetch(`${getApiBaseUrl()}/update-studio/${studioId}`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export async function deleteStudio(studioId) {
    const res = await fetch(`${getApiBaseUrl()}/delete-studio/${studioId}`, {
        method: "POST",
    });
    return await res.json();
}
...
export async function applyCoupon(couponCode) {
    try {
        const res = await fetch(`${getApiBaseUrl()}/public/apply-coupon`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
